...
export default function Rating() {
  ...
  return (
    <div style={{ textAlign: "center" }}>
      <img src={ratingList[ratingValue]} alt="" style={styleImage} />
      <div>
        <button onClick={() => handleRating(0)} style={styleBtn}>
          Bad
        </button>
        <button onClick={() => handleRating(1)} style={styleBtn}>
          Normar
        </button>
        <button onClick={() => handleRating(2)} style={styleBtn}>
          Good
        </button>
        <button onClick={() => handleRating(3)} style={styleBtn}>
          Very good
        </button>
      </div>
    </div>
